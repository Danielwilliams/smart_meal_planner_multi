/**
 * Updated Instacart Backend Service
 * 
 * This is the updated version that uses the Vercel proxy to avoid CORS issues.
 */

import axios from 'axios';

// Always use a relative URL so the Vercel proxy can handle it
const BASE_URL = '';
