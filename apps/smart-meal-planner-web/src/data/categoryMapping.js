const CATEGORY_MAPPING = {
  produce: ["lettuce", "spinach", "carrot", "broccoli", "onion", "garlic", "bell pepper", "cucumber", "tomato", "tomato sauce", "avocado", "lime", "cilantro", "ginger", "potatoes"],
  fruits: ["apple", "banana", "orange", "strawberry", "blueberry", "grape", "pineapple", "mango"],
  beverages: ["milk", "juice", "coffee", "tea", "soda", "water"],
  "dairy-eggs": ["egg", "cheese", "butter", "yogurt", "cream"],
  ...
  "meat-seafood": ["chicken", "beef", "pork", "fish", "shrimp", "salmon", "steak", "sirloin", "flank steak", "flank", "ground beef", "sausage", "bacon"],
