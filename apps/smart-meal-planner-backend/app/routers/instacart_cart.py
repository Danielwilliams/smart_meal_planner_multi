...
async def create_shopping_list(
    ...
    try:
        ...
        # Create shopping list URL using Instacart's official API
        try:
            # Call the Instacart API via helper function
            ...
            # Log the result
            logger.info(f"Created Instacart shopping list URL via API: {url[:60] if url else 'None'}")
