...
def _build_day_prompt(
    ...
    system_lines += [
        "",
        "FOOD SAFETY — MANDATORY FOR ALL MEAT/SEAFOOD:",
        "  When any recipe contains raw meat, poultry, or seafood, the cooking instructions",
        "  MUST state the required internal temperature. Use these USDA minimums:",
        "  • Chicken / turkey (whole, pieces, ground): 165°F (74°C)",
        "  • Ground beef / ground pork: 160°F (71°C)",
        "  • Beef steaks, roasts, pork chops, lamb: 145°F (63°C) — rest 3 min",
        "  • Fish and shellfish: 145°F (63°C) — flesh opaque and flakes easily",
        "  • Shrimp / scallops / lobster: cook until opaque, 145°F (63°C)",
        "  • Ham (fresh/raw): 145°F (63°C) — rest 3 min",
        "  Include the temperature in the final cooking step, e.g.:",
        "    'Cook until chicken reaches an internal temperature of 165°F (74°C).'",
        "",
        "COOK TIME ACCURACY — MANDATORY:",
        "  cook_time_minutes MUST reflect the actual cooking method described:",
        "  • Boneless chicken breast — oven 375°F: 25-30 min | stovetop: 6-8 min/side",
        "  • Ground beef/turkey (stovetop): 8-12 min",
        "  • Salmon fillet — oven 400°F: 12-15 min | stovetop: 4-5 min/side",
        "  • Shrimp (stovetop): 2-3 min/side (do NOT over-time — shrimp cooks fast)",
        "  • Steak 1-inch — medium-rare stovetop: 3-4 min/side",
        "  • Pork chops 1-inch — stovetop: 4-5 min/side | oven 400°F: 20-25 min",
        "  • Roast chicken whole — oven 375°F: 20 min/lb (minimum 60 min)",
        "  • Pasta (boiling): 8-12 min | Rice (stovetop): 18-20 min",
        "  • Eggs scrambled/fried: 3-5 min | Omelette: 3-4 min",
        "  NEVER assign cook_time_minutes=0 to any meal with raw protein.",
        "  NEVER assign cook_time_minutes under 8 to any bone-in poultry or whole cuts.",
        "",
        ...
        "meals": [
            {
                ...
                "instructions": [
                    "Step 1 — prep",
                    "Step 2 — cook (include internal temp for any meat/seafood, e.g. 'until chicken reaches 165°F / 74°C')",
                    "Step 3 — serve",
                ],
                "servings": servings,
                "prep_time_minutes": "int — realistic prep time in minutes",
                "cook_time_minutes": "int — realistic cook time in minutes (NEVER 0 for raw protein)",
                "macros": {
